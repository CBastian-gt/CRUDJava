...
public class ProyectoSemestral {
    ...
    public static void main(String[] args) throws IllegalAccessException, Exception {
        ...
        {
            Logger.getLogger(ProyectoSemestral.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, ex, "ventaVideojuesgos ERROR", 0, null);
        }
        catch (com.mysql.jdbc.exceptions.jdbc4.CommunicationsException | com.mysql.jdbc.exceptions.jdbc4.MySQLSyntaxErrorException   ex)
        {
            Logger.getLogger(ProyectoSemestral.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(null, ex, "ventaVideojuesgos ERROR", 0, null);
            JOptionPane.showMessageDialog(null, "Sistema sale con codigo de error 1, Chequee que el servidor de base de datos este arriba y la base de datos creada.", "ventaVideojuesgos ERROR", 0, null);
